...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q_SWQ_4] = {
        .from_float               = quantize_row_q_swq_4,
        .vec_dot                  = ggml_vec_dot_q_swq_4_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_FIT_2] = {
        .from_float               = quantize_row_q_swq_fit_2,
        .vec_dot                  = ggml_vec_dot_q_swq_fit_2_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_FIT_3] = {
        .from_float               = quantize_row_q_swq_fit_3,
        .vec_dot                  = ggml_vec_dot_q_swq_fit_3_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_HFIT_3] = {
        .from_float               = quantize_row_q_swq_hfit_3,
        .vec_dot                  = ggml_vec_dot_q_swq_hfit_3_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_HFIT_3_128] = {
        .from_float               = quantize_row_q_swq_hfit_3_128,
        .vec_dot                  = ggml_vec_dot_q_swq_hfit_3_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_HFIT_4_128] = {
        .from_float               = quantize_row_q_swq_hfit_4_128,
        .vec_dot                  = ggml_vec_dot_q_swq_hfit_4_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_PLIN3_128] = {
        .from_float               = quantize_row_q_swq_plin3_128,
        .vec_dot                  = ggml_vec_dot_q_swq_plin3_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_PLIN4_128] = {
        .from_float               = quantize_row_q_swq_plin4_128,
        .vec_dot                  = ggml_vec_dot_q_swq_plin4_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q_SWQ_PLIN3Q_128] = {
        .from_float               = quantize_row_q_swq_plin3q_128,
        .vec_dot                  = ggml_vec_dot_q_swq_plin3q_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_1] = {
