...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "Q_SWQ_HFIT_3", LLAMA_FTYPE_MOSTLY_Q_SWQ_HFIT_3, " experimental 4 bpw hierarchical INT8 cubic + anchors", },
    { "Q_SWQ_HFIT_3_128", LLAMA_FTYPE_MOSTLY_Q_SWQ_HFIT_3_128, " experimental 5 bpw row-compatible hierarchical INT8 cubic", },
    { "Q_SWQ_HFIT_4_128", LLAMA_FTYPE_MOSTLY_Q_SWQ_HFIT_4_128, " experimental 7 bpw hierarchical INT8 cubic + 4-bit residual", },
    { "Q_SWQ_PLIN3_128", LLAMA_FTYPE_MOSTLY_Q_SWQ_PLIN3_128, " experimental 5 bpw piecewise linear + 3-bit residual", },
    { "Q_SWQ_PLIN4_128", LLAMA_FTYPE_MOSTLY_Q_SWQ_PLIN4_128, " experimental 7 bpw piecewise linear + 4-bit residual", },
    { "Q_SWQ_PLIN3Q_128", LLAMA_FTYPE_MOSTLY_Q_SWQ_PLIN3Q_128, " experimental 4.625 bpw INT8 piecewise linear + 3-bit residual", },
...
static void usage(const char * executable) {
    ...
    printf("       [--prune-layers] [--keep-split] [--override-kv] [--dry-run] [--swq-stats]\n");
